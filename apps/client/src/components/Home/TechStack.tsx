      ...
      {isRevealed ? (
        ...
        >
          <div className="text-center relative z-10 px-4">
            <Lock
              size={20}
              className="sm:w-6 sm:h-6 mx-auto mb-2 sm:mb-3 text-white"
            />
            <div className="text-sm sm:text-base font-mono">CLASSIFIED</div>
            <div className="text-xs sm:text-sm mt-1 sm:mt-2 font-mono opacity-80">
              Scratch to reveal
            </div>
            <div className="text-xs mt-1 sm:mt-2 font-mono bg-black/30 px-2 py-1 rounded">
    ...
    <div className="min-h-screen relative overflow-hidden bg-black">
      ...
      <div className="relative z-10 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-screen py-12 sm:py-16 lg:py-20">
            ...
            <div className="relative space-y-6 sm:space-y-8">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-black/60 backdrop-blur-md border border-red-400/30 rounded-full flex items-center justify-center flex-shrink-0">
                  <Shield size={16} className="sm:w-5 sm:h-5 text-red-400" />
                </div>
                <span className="text-red-400 font-mono text-xs sm:text-sm lg:text-lg tracking-wide break-words">
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="space-y-3 sm:space-y-4 max-w-xl">
                  <p className="text-lg sm:text-xl lg:text-2xl xl:text-3xl text-gray-300 font-light">
                    Just Like your{" "}
                    <span className="font-mono bg-black/60 backdrop-blur-md border border-red-400/30 px-2 sm:px-3 py-1 rounded-lg text-red-400 text-base sm:text-lg lg:text-xl xl:text-2xl">
                      git data
                    </span>
                  </p>

                  <p className="text-base sm:text-lg lg:text-xl xl:text-2xl text-red-400 italic font-mono">
                    Right?
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-center justify-between bg-black/60 backdrop-blur-md border border-red-400/30 px-3 sm:px-4 py-2 sm:py-3 rounded-lg sm:rounded-xl"
                    >
                      <div className="flex items-center gap-2 sm:gap-3">
                        <item.icon
                          size={14}
                          className="sm:w-4 sm:h-4 text-red-400 flex-shrink-0"
                        />
                      ...
                      <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
                        ...
                        <span className="text-red-400 font-mono text-[10px] sm:text-xs">
                          {item.status}
                        </span>
                      </div>
                    </div>
            ...
            <div className="flex justify-center lg:justify-end relative">
              <div className="relative w-full max-w-lg">
                {/* Glow effect */}
                <div className="absolute inset-0 bg-red-400/20 rounded-2xl sm:rounded-3xl blur-2xl sm:blur-3xl animate-pulse"></div>

                {/* Main card container */}
                <div className="relative bg-black/80 backdrop-blur-md border border-red-400/30 p-4 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl">
                  {!isRevealed ? (
                    <div className="text-center mb-4 sm:mb-6">
                      <div className="flex items-center justify-center mb-2 sm:mb-3">
                        <Server
                          size={20}
                          className="sm:w-6 sm:h-6 text-red-400"
                        />
                      </div>
                      <h3 className="text-base sm:text-lg lg:text-xl font-bold text-red-400 font-mono mb-1 sm:mb-2">
                        CLASSIFIED PARTNERS
                      </h3>
                  ...
                  <ScratchToReveal
                    ...
                    className="flex items-center justify-center overflow-hidden rounded-xl sm:rounded-2xl border-2 border-red-400/50 bg-black"
                    onComplete={handleComplete}
                    gradientColors={["#dc2626", "#ef4444", "#f87171"]}
                  >
                    <div className="w-full h-full bg-black border border-red-400/30 p-2 sm:p-3 flex flex-col items-center justify-center relative">
                      {/* Background pattern */}
                      ...
                      <div className="relative z-10 w-full">
                        {isRevealed && (
                          <div className="text-center mb-3 sm:mb-4">
                            <h4 className="text-sm sm:text-base lg:text-lg font-bold text-red-400 font-mono">
                              AUTHORIZED PARTNERS
                            </h4>
                            <div className="w-12 sm:w-16 h-px bg-red-400 mx-auto mt-1 sm:mt-2"></div>
                          </div>
                        )}
                            ...
                            >
                              <div className="relative group">
                                <img
                                  src={partner}
                                  alt={`Partner ${index + 1}`}
                                  className="w-16 h-14 sm:w-20 sm:h-16 lg:w-24 lg:h-20 rounded-lg shadow-lg border border-red-400/30 object-cover"
                                />
                                {isRevealed && (
                        ...
                        {isRevealed && (
                          <div className="mt-3 sm:mt-4 lg:mt-6 text-center px-2">
                            <div className="bg-red-400/10 border border-red-400/30 rounded-lg p-2 sm:p-3">
                              ...
                              <div className="flex items-center justify-center mt-1 sm:mt-2 space-x-2">
                                <Activity
                                  size={10}
                                  className="sm:w-3 sm:h-3 text-red-400"
                                />
                                <span className="text-red-400 font-mono text-[10px] sm:text-xs">
                                  SECURE CONNECTION
                                </span>
                  ...
                  <div className="absolute top-0 left-0 w-3 h-3 sm:w-4 sm:h-4 border-l-2 border-t-2 border-red-400 rounded-tl-2xl sm:rounded-tl-3xl"></div>
                  <div className="absolute top-0 right-0 w-3 h-3 sm:w-4 sm:h-4 border-r-2 border-t-2 border-red-400 rounded-tr-2xl sm:rounded-tr-3xl"></div>
                  <div className="absolute bottom-0 left-0 w-3 h-3 sm:w-4 sm:h-4 border-l-2 border-b-2 border-red-400 rounded-bl-2xl sm:rounded-bl-3xl"></div>
                  <div className="absolute bottom-0 right-0 w-3 h-3 sm:w-4 sm:h-4 border-r-2 border-b-2 border-red-400 rounded-br-2xl sm:rounded-br-3xl"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Bottom disclaimer */}
          <div className="pb-8 sm:pb-12 lg:pb-16 text-center px-4">
            <div className="bg-black/60 backdrop-blur-md border border-red-400/30 rounded-lg sm:rounded-xl p-4 sm:p-6 max-w-4xl mx-auto">
              ...
              <div className="flex flex-wrap items-center justify-center mt-3 sm:mt-4 gap-3 sm:gap-6 text-xs font-mono">
