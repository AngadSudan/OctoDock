    ...
    <MotionHighlightItem value={value} className="size-full">
      <motion.button
        ...
        className={cn(
          ...
          "relative inline-flex cursor-pointer items-center size-full justify-center whitespace-nowrap px-6 py-3 text-sm font-medium transition-all duration-500 ease-out",

          // Shape and borders
          "border border-white/10",

          // Glassmorphic foundation
          "backdrop-blur-xl bg-gradient-to-br from-white/8 to-white/4",

          // Inactive state
          !isActive && [
            "text-white/60 hover:text-white/80",
            "hover:bg-gradient-to-br hover:from-white/12 hover:to-white/6",
            "hover:border-white/20 hover:shadow-lg hover:shadow-black/5",
          ],

          // Active state - premium glass effect
          isActive && [
            "text-white bg-gradient-to-br from-white/10 to-white/10",
            "border-white/30 shadow-2xl shadow-black/10",
            // Subtle inner highlight
            "before:absolute before:inset-px before:rounded-2xl before:bg-gradient-to-br before:from-white/10 before:to-transparent before:opacity-60",
          ],

          // Focus and accessibility
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/20 focus-visible:ring-offset-4 focus-visible:ring-offset-transparent",
        ...
        style={{
          ...
          boxShadow: isActive
            ? "0 20px 40px rgba(0,0,0,0.1), 0 8px 16px rgba(0,0,0,0.06), inset 0 1px 0 rgba(255,255,255,0.2)"
