...
const OctoDockLogin = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Login | Octodock – Access Your Development Workspace</title>

        <meta
          name="description"
          content="Securely log in to Octodock to access your development workspace, manage containerized environments, and streamline deployment workflows across our global distributed computing grid."
        />

        <meta name="robots" content="noindex, nofollow" />

        {/* Open Graph Meta */}
        <meta property="og:title" content="Login | Octodock" />
        <meta
          property="og:description"
          content="Sign in to access your Octodock workspace and manage next-generation containerized development environments with automated orchestration."
        />
            ...
            <div className="max-w-md text-center px-8">
              ...
              >
                ...
                <p className="text-white text-lg font-light leading-relaxed mb-8">
                  Seamlessly manage your projects, collaborate with your team,
